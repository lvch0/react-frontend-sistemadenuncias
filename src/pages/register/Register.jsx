    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!err?.response) {
                ...
                setErrMsg('Nombre de usuario tomado');
            } else {
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <p id="confirmnote" className={matchFocus && !validMatch ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            Debe coincidir con el primer campo de entrada de la contraseña.
                        </p>

                        <button disabled={!validName || !validPwd || !validMatch ? true : false}>Registrate</button>
                    </form>
                    <p>
